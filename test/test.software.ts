...
import { directoryDependsOn, dirDoesNotDependOn } from "../rules/software.ts";
...
describe("test the validity of software dependencies", () => {
  it("limit business domain to mongodb", async () => {
    assert(await directoryDependsOn("./test/ddd/business/infrastructure", "npm:mongodb^*", "https://deno.land/std"));
  });
